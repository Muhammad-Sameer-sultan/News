...
const TopNews = () => {
      ...
      <div className="card-body">
        ...
        <p className="card-text"><small className="text-body-secondary">Last updated 3 mins ago</small></p>
         ...
         <div className=" col-lg-8">
          ...
          <img
            src={
              "https://static.independent.co.uk/2023/10/19/08/GettyImages-1177529356.jpg?quality=75&width=640&auto=webp"
            }
            className="w-100"
            style={{ height: "380px" }}
            alt=".."
          ></img>
          <div className="position-absolute bg-dark bg-gradient bg-opacity-75 p-3 text-light w-100"
            style={{bottom: "0"}}
          >
            <h5 className="display-6 fst-italic">
              Title of a longer featured blog post
            </h5>
            
            <p className="lead mb-0">
              <a href={"/"} className=" fw-bold text-light">
                Continue reading...
              </a>
            </p>
          </div>
 ...
 <div className="card my-2" style={{width: "22rem"}}>
  <div className="card-body">
    ...
    <a href="/" className="btn main-btn">Read more ...</a>
  </div>
</div>
         <div className="card my-2" style={{width: "22rem"}}>
  <div className="card-body">
    <h5 className="card-title">Special title treatment</h5>
    <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
    <a href="/" className="btn  main-btn">Go somewhere</a>
  </div>
</div>
  </div>
         </div>
